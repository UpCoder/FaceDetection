...
if __name__ == '__main__':
    ...
    #
    # img1 = imread('./tiger.jpg', mode='RGB')
    # img1 = imresize(img1, (224, 224))
    #
    # prob = sess.run(vgg.probs, feed_dict={vgg.imgs: [img1]})[0]
    # preds = (np.argsort(prob)[::-1])[0:5]
    # print 'feature shape is ', vgg.feature.shape
    # for p in preds:
    #     print class_names[p], prob[p]
    flod_dir = '/home/give/Documents/dataset/FaceDetection/Bounding_Box/01'
    test_image_path = '/home/give/Documents/dataset/FaceDetection/TenFolds/06/img_33.jpg'
        ...
        for score in test_scores:
            if score >= EQUAL_THRESHOLD:
                ...
                Tools.save_rect_in_image(
                    ...
                    [1],
                    [score],
                    '/home/give/PycharmProjects/FaceDetection/fine_tuning_vgg16/result'
                )
            else:
